...
export const getCorridorReliefHeight = ({
    worldX,
    worldZ,
    maxX,
    laneCenterZ = 10,
    ...
    return rawY * pathClearing + microNoise * pathClearing;
};

export const CorridorReliefGround = memo(({
    maxX,
    groundY,
    laneCenterZ = 10,
    ...
    const terrainGeometry = useMemo(() => {
        ...
        for (let index = 0; index < positions.count; index++) {
            ...
            const worldY = getCorridorReliefHeight({worldX, worldZ, maxX, laneCenterZ});
    ...
    const rockMatrices = useMemo(() => {
        ...
        for (let index = 0; index < 400; index++) {
            ...
            const terrainY = getCorridorReliefHeight({worldX, worldZ, maxX, laneCenterZ});
...
CorridorReliefGround.displayName = "CorridorReliefGround";
