...
import {
  Scene as PresidentsMonthlySalariesScene,
  durationInFrames as presidentsMonthlySalariesDuration,
} from "./compositions/2026-06-09-presidents-monthly-salaries";
...
export const RemotionRoot: React.FC = () => {
  return (
    <>
      ...
      />
      <Composition
        id="2026-06-09-presidents-monthly-salaries"
        component={PresidentsMonthlySalariesScene}
        durationInFrames={presidentsMonthlySalariesDuration}
        fps={60}
        width={1920}
        height={1080}
      />
