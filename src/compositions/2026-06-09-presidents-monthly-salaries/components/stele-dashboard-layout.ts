...
export const MEDIA_FRAME_MIN_WIDTH = 24.0;
export const MEDIA_FRAME_MAX_WIDTH = 34.0;
export const MEDIA_FRAME_MIN_HEIGHT = 18.0;
export const MEDIA_FRAME_INSET = 0.9;
export const SCREEN_WIDTH = 18;
export const SCREEN_HEIGHT = 13;
export const DATA_PANEL_HEIGHT = 16.0;
export const RANK_Y = MEDIA_FRAME_HEIGHT / 2 + 10.5;
export const MEDIA_MAX_RANK_Y = 28.5;
