...
test.skip("main-pass timing keeps short cuts and readable nine-second holds", () => {
...
test.skip("camera holds on one stele with a stable rightward rail drift and fixed depth", () => {
