...
- `2026-04-06 cleanup`: исторические review-artifacts удалены из репозитория; manifest сохраняет только живые runtime-ассеты и dataset snapshot, а ссылки на старые still-артефакты убраны
...
- `2026-04-02 rail handoff speed tweak v3`: скорость rail-переезда дополнительно снижена еще на `50%` относительно версии с `72` кадрами; move-gap увеличен до `108` кадров без изменения hold
